      ...
      <Dialog open={showFieldDialog} onOpenChange={setShowFieldDialog}>
        <DialogContent className="bg-gray-900 border-gray-800">
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2"><Label>Field Label (Required)</Label><Input value={newFieldLabel} onChange={e => setNewFieldLabel(e.target.value)} placeholder="e.g. Player Name, Score" className="bg-gray-800 border-gray-700" autoFocus /></div>
            <div className="space-y-2"><Label>Field Name (Optional)</Label><Input value={newFieldName} onChange={e => setNewFieldName(e.target.value)} placeholder="e.g. player_name" className="bg-gray-800 border-gray-700" /><p className="text-xs text-gray-500">Auto-generated from label if left empty</p></div>
          </div>
          <DialogFooter>
